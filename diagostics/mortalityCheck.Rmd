...
tr <- fullMod(x = 50, y = 50, dispersal = 3, runs = 10000, specRate = 2.0, density = F, environment = T, mortalityFitness = T, mortalityStrength = 50, reproductiveFitness = F, neutral = F, dispersalCut =1, densityCut = 2, seed = 100)
