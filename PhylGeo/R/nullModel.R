...
#' nullModel(simu, localPlotSize = 100, numberOfPlots = 10, repetitions = 10)
#' 
...
#' 
#' @export
nullModel <- function(simu, which.simulation=NULL, localPlotSize, numberOfPlots, repetitions){
  ...
  observedMPD = picante::mpd(samp = comMat, dis = extantPhyloCophen, abundance.weighted = T) # calculate fun for "real matrix
