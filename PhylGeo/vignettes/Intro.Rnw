...
These processes can be distinguished in two main classes, environmental filtering and local interactions.
...
The output is saved as a list. The first two list slices contain the results of the  simulation after 500 and 1000 runs, whereas the last list slice contains the parameter settings.
