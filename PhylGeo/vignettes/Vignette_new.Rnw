...
Further, the package comprises a plot function to highlight the clade of a local community within a metacommunity. The local community can be given to the function directly or is derived from the simu object via localPlots.

<<>>=
plotclades(simu, size = 50, n = 3) 
@
