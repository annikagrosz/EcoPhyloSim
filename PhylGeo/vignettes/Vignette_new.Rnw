...
You can choose, wheather the null model should be based on the abundance distribution of the 
sample plots or not.

<<>>=
pValues <- nullModel(simu = simu, abundance = FALSE, localPlotSize = 100, numberOfPlots = 10, repetitions = 100)
@
