...
string Parameters::m_XMLFileName;
string Parameters::m_PathToXmlFile;

bool Parameters::m_WriteCurrentParameterToXMlFile;
bool Parameters::m_CreateParameters;
bool Parameters::m_ReadParametersFromXMLFile;
bool Parameters::m_LogInfos;
...
Parameters::Parameters() {
   // Init static member
   Parameters::m_XMLFileName = string("PhylogenyParameters.xml");
   Parameters::m_PathToXmlFile = string("XML/Data/");
...
//   Parameters::m_ReadParametersFromXMLFile = !Parameters::m_WriteCurrentParameterToXMlFile;
   Parameters::m_WriteCurrentParameterToXMlFile = true;
   Parameters::m_ReadParametersFromXMLFile = true;
   Parameters::m_CreateParameters = true;
   Parameters::m_LogInfos = true;

   if (m_CreateParameters) {
      createParameters();
   }
...
//   }
   if (Parameters::m_ReadParametersFromXMLFile) {
      readParameterFromXMLFile();
   }
   if (Parameters::m_WriteCurrentParameterToXMlFile) {
      writeParametersToXMLFile();
   }
}
...
void Parameters::writeParametersToXMLFile() {
   ...
   const char* file = (m_PathToXmlFile + m_XMLFileName).c_str();
//   const char* file = m_XMLFileName.c_str();
   if (m_LogInfos) {
...
void Parameters::readParameterFromXMLFile() {
   string xmlFileName = m_PathToXmlFile + m_XMLFileName;
