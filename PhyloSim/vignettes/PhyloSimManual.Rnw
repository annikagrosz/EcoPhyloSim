...
\begin{table}[h]
\centering
\caption{Speciation Mechanisms in the PhyloSim package}
\label{SpecMec}
\begin{tabular}{l|p{7cm}} 
\toprule
Speciation Mechanism  & Effect                                                                                                                                             \\ \midrule
...
Protracted Speciation & Based on \cite{rosindell2010} species undergoes an 'incipient' stage before becomming a new species.                                           \\
Red Queen             & Based on \cite{odwyer2014} New species have advantages over old species due to their novelty alone. The effect vanishes over time. \\ \bottomrule
\end{tabular}
\end{table}
...
\paragraph{Highlight Local Communities} hihglightLocalPhylo highlights a phylogeny of a local community within a metacommunity. 
