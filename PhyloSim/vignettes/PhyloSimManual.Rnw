...
If the Phylsim object contains multiple results, they can be accessed by the which.result argument in most functions. By default always the last result is used.\\
