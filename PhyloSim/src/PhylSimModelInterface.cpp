...
Rcpp::List callModel(int x, int y, int dispersal, IntegerVector runs, double specRate, bool dens, 
               ...
               int densityCutoff, int seed, double envStrength, double compStrength, bool fission, int fissionType) {
   ...
   PhylSimModel phylSimModel(x, y, dispersal, runs[steps-1], specRate, dens, 
               ...
               densityCutoff, tempSaveLoc, envStrength, compStrength, fission, fissionType);
