...
//						}
                ...
                if (density) {
                    ...
                    if ((mcord - 1) < 0 && (ncord - 1) >= 0 && (mcord + 1) < length_x &&
                        (ncord + 1) < length_y) // left boundary
                    {
                        unsigned long long neighbors[4] = {a.area[length_x][ncord].species,
                                                           a.area[mcord + 1][ncord].species,
                                                           a.area[mcord][ncord - 1].species,
                                                           a.area[mcord][ncord + 1].species};
                    } else if ((mcord - 1) >= 0 && (ncord - 1) < 0 && (mcord + 1) < length_x &&
                               (ncord + 1) < length_y) // top boundary
                    {
                        unsigned long long neighbors[4] = {a.area[mcord - 1][ncord].species,
                                                           a.area[mcord + 1][ncord].species,
                               ...
                               (ncord + 1) < length_y) // right boundary
                    {
                        unsigned long long neighbors[4] = {a.area[mcord - 1][ncord].species,
                               ...
                               (ncord + 1) >= length_y) // bottom boundary
                    {
                        unsigned long long neighbors[4] = {a.area[mcord - 1][ncord].species,
                                                           a.area[mcord + 1][ncord].species,
                                                           a.area[mcord][ncord - 1].species,
                               ...
                               (ncord + 1) < length_y) // top-left boundary
                    {
                        unsigned long long neighbors[4] = {a.area[length_x][ncord].species,
                                                           a.area[mcord][length_y].species,
                                                           a.area[mcord + 1][ncord].species,
                               ...
                               (ncord + 1) < length_y) // top-right boundary
                    {
                        unsigned long long neighbors[4] = {a.area[mcord - 1][ncord].species,
                                                           a.area[0][ncord].species,
                                                           a.area[mcord][length_y].species,
                               ...
                               (ncord + 1) >= length_y) // bottom-right boundary
                    {
                        unsigned long long neighbors[4] = {a.area[mcord - 1][ncord].species,
                                                           a.area[0][ncord].species,
                                                           a.area[mcord][ncord - 1].species,
                               ...
                               (ncord + 1) >= length_y) // bottom-left boundary
                    {
                        unsigned long long neighbors[4] = {a.area[length_x][ncord].species,
                                                           a.area[mcord + 1][ncord].species,
                                                           a.area[mcord][ncord - 1].species,
...
leipzigModel::leipzigModel(int x, int y, unsigned long long z, int specrate, bool dens,
                           double densStr) { // provides a way to initialize the constructor
    length_x = x;
    length_y = y;
