...
for(i in 1:28){
  ...
  text(x=60000, y= ypos, labels=paste("mean = ",mean(SpeciesRichness100[i,])))
...
sac(simulationOut100[[i]], which.simulation = "all", title= "all Simulations")  
  ...
  name <- paste("./",outfolder100, "/SAC100_", i, ".pdf", sep = "")
  dev.copy(pdf,name, width=9, height=6)
  dev.off()
...
rac(simulationOut100[[i]], which.simulation = "all", title= "all Simulations")  
  ...
  name <- paste("./",outfolder100, "/RAC100_", i, ".pdf", sep = "")
  dev.copy(pdf,name, width=9, height=6)
  dev.off()
