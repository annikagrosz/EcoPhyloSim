...
createCompletePar <- function(x = 50, y = 50, dispersal = "global", runs = 100, specRate = 1.0, density = 0, environment = 0, fitnessActsOn = "mortality" , fitnessBaseMortalityRatio = 10, densityCut = 1, seed=NULL,  type = "base", fission = 1, redQueen = 0, redQueenStrength = 0, scenario = NULL){
  ...
  par = list(x=x,y=y,dispersal = dispersal, runs = runs, specRate = specRate, 
             ...
             redQueen = redQueen, redQueenStrength = redQueenStrength)
